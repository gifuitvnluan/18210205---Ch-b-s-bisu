...
$site_top = "http://chubo-s.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "m-watanabe@eks-hoan.co.jp,yu-suzuki@eks-hoan.co.jp";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "m-watanabe@eks-hoan.co.jp,yu-suzuki@eks-hoan.co.jp";
...
$thanksPage = "http://chubo-s.jp/thanks.html";
...
$require = array('お名前','フリガナ','メールアドレス','ご住所','電話番号','お問い合わせ内容');
